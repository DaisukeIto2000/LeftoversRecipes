...
class PasswordController extends Controller
{
    ...
    /**
      ...
      */
      ...
      {
          return view('recipes.reset_password.email_form');
      }
      ...
      */
      public function sendComplete()
      {
         // メール送信処理で保存したセッションキーに値がなければアクセスできないようにすることで不正アクセスを防ぐ
          ...
          return view('recipes.reset_password.send_complete');
      }
      ...
      */
      public function edit(Request $request)
      {
          ...
          return view('recipes.reset_password.edit')
      ...
      */
      public function edited()
      {
          ...
          return view('recipes.reset_password.edited');
      }
